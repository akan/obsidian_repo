...
source: "https://mp.weixin.qq.com/s/QHsu5I4o1kvWmgWDGR6E4Q"
author:
  - "[[贺张俭]]"
published:
created: 2025-11-04
description: "一方面，是Vibe效率的飞升：三天完成一个Demo，一下午Vibe一个Poc项目。"
tags:
  - "AI开发效率"
  - "个人与企业差异"
  - "模型能力限制"
  - "信息孤岛"
  - "工作流程"
abstract: "文章分析了AI开发在个人层面效率显著提升但在企业层面效果有限的原因，主要涉及模型能力、信息系统孤岛和工作流程三个层面的瓶颈。"
---
![cover_image](https://mmbiz.qpic.cn/mmbiz_jpg/BHJD6uDwAapLsnnfJzuNUHfFAu19sdPg5e8VH7AwoEsA4PibOfcNYMstfq4uVuD46ticLT9uJPhaDnLz1LoYCciaA/0?wx_fmt=jpeg)

Original 贺张俭 [张俭的博客](https://mp.weixin.qq.com/s/) *2025年10月27日 07:54*
...
![Image](https://mmbiz.qpic.cn/mmbiz_png/BHJD6uDwAapLsnnfJzuNUHfFAu19sdPgnGQgKR8xOz6Keyp3ozApJWe0f8ibgToDqKsTDia1yXIsqgqjh4PTPsgg/640?wx_fmt=png&from=appmsg&watermark=1&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=0)
...
![Image](https://mmbiz.qpic.cn/mmbiz_png/BHJD6uDwAapLsnnfJzuNUHfFAu19sdPgQTxaLFSRqxO8T2TcSRic74O1hFTpsqicZvWvUia7zXm5vq4wfYjbLt6ow/640?wx_fmt=png&from=appmsg&watermark=1&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=1)

  
测试负责产品质量的出口，测试在自己的领域范围内，通过自己的理解，对整体的测试进行分层落地（基本接口测试与集成测试环节）。图中共有四项活动：代码、单元测试、基本接口测试、集成测试。这个模式下，单元测试与基本接口测试存在能力上的重叠。对流程进行了如下优化（测试将测试设计左移，基本接口测试放在开发阶段，弱化单元测试。

![Image](https://mmbiz.qpic.cn/mmbiz_png/BHJD6uDwAapLsnnfJzuNUHfFAu19sdPgKW0bwV9U2NeCBubAUWibH9Ql7qFpgauwLYXqoDURmQet7qYDB48Dia7A/640?wx_fmt=png&from=appmsg&watermark=1&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=2)

  

  
从传统领域的角度来看，下面的方式，测试更早介入，且减少了重复工作。但是从AI辅助的角度来看，哪个效率更高？
