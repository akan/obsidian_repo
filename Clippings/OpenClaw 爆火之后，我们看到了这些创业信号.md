...
source: "https://mp.weixin.qq.com/s/7Hb42uP46guEpxP4KWomDA"
author:
  - "[[镜山]]"
published:
created: 2026-02-10
description: "它打开了哪些创业方向？"
tags:
  - "AI代理"
  - "创业方向"
  - "开源验证"
  - "物理执行"
  - "语音交互"
abstract: "文章探讨了开源AI代理项目OpenClaw验证了AI从聊天转向执行任务的能力，并由此打开了多个创业方向，包括与可穿戴设备结合、建立AI自主信用系统、连接物理世界执行层以及整合语音交互等。"
---
Original 镜山 *2026年2月5日 22:51*

> 它打开了哪些创业方向？

  

![loading](https://mmbiz.qpic.cn/sz_mmbiz_jpg/a16Y4PLxPqnxZiaURbicLcGz9BF8fFxq7DnrXkj3plqkuOt2qIF4g8h1daL1KLyfn9SAxX658Vyg9dibE9CdyJaDJCvzO2ZHtxCHJhPQUq5Y2w/640?wx_fmt=other&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=0)
...
![loading](https://mmbiz.qpic.cn/sz_mmbiz_jpg/a16Y4PLxPqnw34rbnHCiaagSZmqZzhoDggBg9qobfW7L5X6mxhMOQKUmEia7fU7yAKoCNy4nkj1nHK6icUcDW20icsOke8EDXV1e3xbFC9Oux2U/640?wx_fmt=other&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=1)
...
![Image](https://mmbiz.qpic.cn/mmbiz_jpg/a16Y4PLxPqn02p3p7cMSgR5LFBnzWE6NxvZkmVqy42oZZst6rBVMQSCkkq45QL9zDCicHemyiclzgUibSLVde1ULpqvibEADycYMfUJx9zJk8q0/640?wx_fmt=other&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=2)
...
如果评分通过，Agent 就拿到了一笔信用额度。之后它去调用那些 支持 x402 类型（一个 Web 原生的支付标准）的付费服务 时，直接刷这个额度就行，不需要你提前充值。
...
注册的时候有个很有意思的环节：要填写 人类自己的 Skills（类似于 Claude Code 的 Skills）。
