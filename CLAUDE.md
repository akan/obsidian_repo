...
- **mehrmaid**：Mermaid 图表增强
- **mermaid-tools**：Mermaid 工具
- **dataview**：数据视图和查询
- **obsidian-excalidraw-plugin**：手绘图表
- **smart-connections**：智能连接
- **flowcharts**：流程图
- **advanced-canvas**：高级画布
## 目录结构
- `/Clippings/`：保存的网页内容和文章（包含大量 AI 和技术相关文章）
- `/Excalidraw/`：图表和视觉笔记
...
- `/idea/`: 一些平时的想法
- `/health/`: 养生相关的文章
- `/copilot-custom-prompts/`: 自定义 AI 助手提示词
- `未命名.base`: BASE 数据库文件
## 常见任务
### 任务类型一、笔记创建流程
#### 1. 选择模板
